...
const projects = [
  {
    ...
    description:
      'A fully custom moderation and security bot built for a 2k+ member community. Features auto-mod, ticket system, leveling, and custom role management. (Still under development)',
  ...
  },
  {
    ...
    packageColor: 'text-purple-400 bg-purple-500/10 border-purple-500/20',
    description:
      'A high-energy gambling community server built for 2k+ members, featuring cleanly organized channels, verified member roles, powerful bots, and a fully branded, engaging aesthetic.',
              ...
              {project.url ? (
                ...
                >
                  <motion.div
                    ...
                    className="group relative bg-[#12121a] border border-white/[0.08] hover:border-purple-500/25 rounded-2xl overflow-hidden transition-all duration-300 cursor-pointer"
                  >
